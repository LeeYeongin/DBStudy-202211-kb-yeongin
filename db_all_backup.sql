...
INSERT INTO `score_mst` VALUES (1,'신경수',100),(2,'고희주',95),(3,'장건녕',85),(4,'문승주',80),(5,'이승아',75),(6,'김수현',65),(7,'문경원',50),(8,'이일인',-10);
...
INSERT INTO `user_dtl` VALUES (1,'김준일','aaa@gmail.com','01012345678'),(2,'이영인','bbb@gmail.com','01051951766'),(3,NULL,NULL,NULL),(4,NULL,NULL,NULL),(5,NULL,NULL,NULL),(6,NULL,NULL,NULL),(7,NULL,NULL,NULL),(8,NULL,NULL,NULL),(9,NULL,NULL,NULL),(10,NULL,NULL,NULL),(11,NULL,NULL,NULL),(12,NULL,NULL,NULL);
...
INSERT INTO `user_mst` VALUES (1,'test'),(2,'test2'),(3,'aaa'),(4,'bbb'),(5,'ccc'),(6,'ddd'),(7,'eee'),(8,'junil1234'),(9,'a1'),(10,'b1'),(11,'d1'),(12,'abcd');
...
-- Dump completed on 2022-12-16 12:54:10
...
CREATE TABLE `order_dtl` (
  ...
  `oder_stock` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `product_mst` VALUES (1,'스타벅스 블랙 텀블러',25000),(2,'스타벅스 화이트 텀블러',30000),(3,'스타벅스 블루 텀블러',20000),(4,'스타벅스 블랙 머그컵',15000),(5,'스타벅스 화이트 머그컵',20000),(6,'스타벅스 블루 머그컵',25000),(7,'스타벅스 블랙 머그컵2',15000),(8,'스타벅스 화이트 머그컵2',20000),(9,'스타벅스 블루 머그컵2',25000);
...
CREATE TABLE `study_notice_img` (
  ...
  `img_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
LOCK TABLES `user_dtl` WRITE;
/*!40000 ALTER TABLE `user_dtl` DISABLE KEYS */;
INSERT INTO `user_dtl` VALUES (1,NULL,NULL,'2022-12-09 10:46:04','2022-12-09 10:46:04'),(3,NULL,NULL,'2022-12-09 10:46:04','2022-12-09 10:46:04'),(4,NULL,NULL,'2022-12-09 10:46:04','2022-12-09 10:46:04');
/*!40000 ALTER TABLE `user_dtl` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_mst` WRITE;
/*!40000 ALTER TABLE `user_mst` DISABLE KEYS */;
INSERT INTO `user_mst` VALUES (1,'aaa','1234','김준일','aaa@gmail.com','2022-12-09 10:46:04','2022-12-09 10:46:04'),(2,'bbb','1234','김준일','aaa@gmail.com','2022-12-09 10:46:04','2022-12-09 10:46:04'),(3,'ccc','1234','김준일','aaa@gmail.com','2022-12-09 10:46:04','2022-12-09 10:46:04'),(4,'ddd','1234','김준일','aaa@gmail.com','2022-12-09 10:46:04','2022-12-09 10:46:04');
/*!40000 ALTER TABLE `user_mst` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
